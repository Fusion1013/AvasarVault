...
cost_plant: gp
---
A type of [[Plants|Plant]]. A poppy with a magic based reproduction cycle, creating a powerful explosion when it wants to spread its seeds. The poppy head can be used to create potion versions of the spell "Faerie Fire" or the seed casings can be ground to make brightly colored dyes that periodically change colour when used on cloth.