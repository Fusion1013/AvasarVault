...
# Grammar
Soldovin is a Aggultinative Language, meaning that single words change meaning to fit different grammatical contexts. It works by stringing together morphemes, each representing a single grammatical meaning. Affixes are added to a root word in a linear and systematic way.

For example, the prefix 'So' can be added to the word 'Dar', to create So'Dar, meaning 'The One True'.
## Sentence Structure
Soldovin uses SOV-order (Subject-Verb-Object).
## Prefixes
| Prefix | Meaning                                  | Example               |
| ------ | ---------------------------------------- | --------------------- |
| So     | The One / Chosen / The First / The Prime | So'Dar - The One True |
